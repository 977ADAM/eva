...
Если в блоке "Что ты знаешь о пользователе" уже есть факты — учитывай их в ответах
и используй, когда тебя спрашивают, что ты о пользователе знаешь.
...
- "что ты обо мне знаешь" → {"say":"Ты пьёшь кофе без сахара.","action":"talk"}"""
